...
const ChatgptConvertDialog = (props: any) => {
      ...
      <DialogContent className="dialog-size p-0 m-0">
        ...
        <Card className="h-full w-full flex flex-col overflow-hidden">
          <CardHeader className="p-4 border-b border-[#c8c8c8] flex justify-between items-center">
            <CardTitle className="text-lg md:text-1xl lg:text-2xl whitespace-nowrap overflow-hidden text-ellipsis capitalize">{props.title}</CardTitle>
          </CardHeader>
...
export default ChatgptConvertDialog;